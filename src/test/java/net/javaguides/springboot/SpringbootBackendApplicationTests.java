...
{
when(repository.findAll()).thenReturn(Stream.of(new Employee(1,"pqr","stv","P@xyz.com","1234567809","Kolhapur","Current")).collect(Collectors.toList()));
...
public void createEmployee() {
    Employee e1 = new Employee(1,"pqr","stv","P@xyz.com","1234567809","Kolhapur","Current");
